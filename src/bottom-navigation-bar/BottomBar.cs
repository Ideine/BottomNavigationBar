...
namespace BottomNavigationBar
{
	public class BottomBar : RelativeLayout, View.IOnClickListener, View.IOnLongClickListener
	{
		...
		public void SetMenuActiveTabColor (String activeTabColor)
		{
			_menuSelectedolor = (Color.ParseColor (activeTabColor));
		}

		public void SetMenuActiveTabColor (Color activeTabColor)
		{
			_menuSelectedolor = activeTabColor;
		}
			...
			foreach (var bottomBarItemBase in listOfBottomBarItems) {
				...
				if (_isShiftingMode && !_isTabletMode) {
					...
					if (!IsNoTitleMode) {
						...
						layoutResource = _isTabletMode ? Resource.Layout.bb_bottom_bar_item_fixed_tablet : Resource.Layout.bb_bottom_bar_item_fixed_no_title;
					}
				}
